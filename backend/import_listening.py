...
print("=" * 80)
print("IMPORTING IELTS LISTENING PRACTICE TEST")
print("=" * 80)
print("\nThis script imports a complete IELTS Listening test with:")
print("  - Part 1 (Q1-10): Gap fill questions")
print("  - Part 2 (Q11-20): Multiple choice + Gap fill")
print("  - Part 3 (Q21-30): Multiple choice")
print("  - Part 4 (Q31-40): Gap fill questions")
