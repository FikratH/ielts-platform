                    ...
                    >
                        ...
                        <div className="p-4 sm:p-6 md:p-8">
                            <div className="flex flex-col sm:flex-row sm:justify-between items-start mb-3 md:mb-4 gap-2 md:gap-3">
                                <h3 className="font-bold text-base sm:text-xl md:text-2xl text-gray-800 leading-tight group-hover:text-blue-700 transition-colors duration-300 line-clamp-2">
                                    {test.title}
                                </h3>
                        ...
                        <div className="px-4 sm:px-6 md:px-8 pb-4 sm:pb-6 md:pb-8 mt-auto">
                            <div className="flex justify-around text-center mb-4 md:mb-6 p-3 md:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg md:rounded-xl border border-blue-100">
                                <div className="flex flex-col items-center">
                                    <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center mb-1 md:mb-2 shadow-md">
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <span className="font-bold text-base md:text-lg text-gray-800">40</span>
                            ...
                            <button 
                                ...
                                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white py-3 md:py-4 rounded-lg md:rounded-xl font-bold text-sm md:text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-0 focus:outline-none focus:ring-4 focus:ring-blue-300 active:scale-95"
                            >
                            ...
                            {test.user_completed && test.explanation_url && (
                              <a
                                ...
                                className="mt-2 md:mt-3 inline-flex w-full items-center justify-center bg-white text-blue-700 border border-blue-200 hover:border-blue-300 hover:bg-blue-50 py-2 md:py-3 rounded-lg md:rounded-xl font-semibold text-xs md:text-sm shadow-sm transition-all duration-200"
                              >
                                Test explanation
                              </a>
                            )}
